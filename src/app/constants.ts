export const STATE_KEY = "sorteio_estado_completo";
export const DRAW_MODE_KEY = "devgacha_draw_mode";
export const APPRENTICE_UNLOCK_LEVEL = 3;
export const FINAL_CLASS_UNLOCK_LEVEL = 5;
